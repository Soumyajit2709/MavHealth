...
public class DoctorAdapterFilterd extends RecyclerView.Adapter<DoctorAdapterFilterd.DoctoreHolder2> implements Filterable {
    ...
    public DoctorAdapterFilterd(List<Doctor> tubeList){
        mTubeList = tubeList;
    ...
    public void onBindViewHolder(@NonNull DoctoreHolder2 doctoreHolder, int i) {
        ...
        doctoreHolder.speciality.setText("Speciality : "+doctor.getSpeciality());
