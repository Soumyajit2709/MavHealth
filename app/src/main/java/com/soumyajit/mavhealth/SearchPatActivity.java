...
public class SearchPatActivity extends AppCompatActivity {
    ...
    private DoctorAdapterFilterd adapter;
    ...
    private void setUpRecyclerView() {
        ...
        query.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                adapter = new DoctorAdapterFilterd(task.getResult().toObjects(Doctor.class));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                DoctorAdapterFilterd.specialitySearch = false;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.option_all) {
            DoctorAdapterFilterd.specialitySearch = true;
            adapter.getFilter().filter("");
            return true;
        } else if (id == R.id.option_general) {
            DoctorAdapterFilterd.specialitySearch = true;
            adapter.getFilter().filter("Medicine General");
            return true;
        } else if (id == R.id.option_Dentist) {
            DoctorAdapterFilterd.specialitySearch = true;
            adapter.getFilter().filter("Dentist");
            return true;
        } else if (id == R.id.option_Ophthalmologist) {
            DoctorAdapterFilterd.specialitySearch = true;
            adapter.getFilter().filter("Ophthalmologist");
            return true;
        } else if (id == R.id.option_ORL) {
            DoctorAdapterFilterd.specialitySearch = true;
            adapter.getFilter().filter("ORL");
            return true;
        } else if (id == R.id.option_Pediatrician) {
            DoctorAdapterFilterd.specialitySearch = true;
            adapter.getFilter().filter("Pediatrician");
            return true;
        } else if (id == R.id.option_Radiologist) {
            DoctorAdapterFilterd.specialitySearch = true;
            adapter.getFilter().filter("Radiologist");
            return true;
        } else if (id == R.id.option_Dermatologist) {
            DoctorAdapterFilterd.specialitySearch = true;
